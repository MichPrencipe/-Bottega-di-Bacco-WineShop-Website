<div class="container mt-4">
  <h3 class="text-center text-uppercase" style="font-weight: bold;">Registrati</h3>
</div>
...
<div class="container mt-4">
  <form id="registrazione" action="#" method="POST">
    ...
    <div class="form-group input-group">
      ...
      <select name="ruolo" class="custom-select" style="max-width: 120px;">
    ...
    <div class="form-group input-group">
      ...
      <input name="indirizzo" class="form-control" placeholder="Indirizzo" type="text" required>
    </div>
    <div class="form-group input-group">
      <div class="input-group-prepend">
        <span class="input-group-text"> <i class="fa fa-paper-plane"></i> </span>
      </div>
      <input name="città" class="form-control" placeholder="città" type="text" required>
    </div>
    ...
    <div class="form-group input-group">
      ...
      <input name="provincia" class="form-control" placeholder="provincia" type="text" required>
    </div>
    ...
    <div class="form-group input-group">
      ...
      <input name="CAP" class="form-control" placeholder="CAP" type="text" required>
    </div>
    ...
    <div class="form-group input-group">
      ...
      <input name="cell" class="form-control" placeholder="Cellulare" type="text" required>
    </div>
